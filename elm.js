...
var $author$project$Main$Model = F3(
	function (currentTime, startTime, tick) {
		return {o: currentTime, G: startTime, r: tick};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A3($author$project$Main$Model, 0, '05:00', 0),
...
var $author$project$Main$sumTime = function (list) {
	if (list.b && list.b.b) {
		var h = list.a;
		var _v1 = list.b;
		var m = _v1.a;
		return ($author$project$Main$parseString(h) * 60) + $author$project$Main$parseString(m);
	} else {
		return 0;
	}
};
			...
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							o: model.o - model.r,
							r: (((model.o - model.r) <= 0) || (!model.r)) ? 0 : 1
						}),
					$elm$core$Platform$Cmd$none);
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: $author$project$Main$sumTime(
								A2($elm$core$String$split, ':', model.G)),
							r: 1
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
...
var $author$project$Main$view = function (model) {
	var seconds = $elm$core$String$fromInt(model.o % 60);
	var minutes = $elm$core$String$fromInt((model.o / 60) | 0);
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
